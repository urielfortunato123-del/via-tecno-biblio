  ...
  head: () => ({
    meta: [
      ...
      { title: "Via Norma – Assistente Técnico de Campo" },
      {
        name: "description",
        content:
          "Assistente técnico de campo com Biblioteca Técnica offline para fiscalização rodoviária.",
      },
      { name: "author", content: "Via Norma" },
      { property: "og:title", content: "Via Norma – Assistente Técnico de Campo" },
      {
        property: "og:description",
        content: "Biblioteca Técnica offline para fiscais, engenheiros e conservação rodoviária.",
      },
